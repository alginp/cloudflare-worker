...
<body class="p-4 md:p-12">
    ...
    <!-- LAYER 1: Sisi Luar (Putih Abu-abu / Platinum) -->
    ...
    <!-- LAYER 2: Outline Merah Gelap (Biar ada kontras di pinggir) -->
    <path fill="#991B1B" d="M32,2c-12.15,0-22,9.85-22,22c0,5.799,3.469,11.469,5.913,15L32,61l16.077-22C50.281,35.781,54,29.799,54,24 C54,11.85,44.15,2,32,2z"/>
    
    <!-- LAYER 3: Body Utama (Orange Kemerahan / Bright Red-Orange) -->
    <path fill="#F76D57" d="M32,4c-11,0-20,9-20,20c0,5.3,3.1,10.5,5.4,13.7L32,57l14.6-19.3c2.3-3.2,5.4-8.4,5.4-13.7 C52,13,43,4,32,4z"/>
    
    <!-- LAYER 4: TENGAH PUTIH SOLID (Gak bakal bolong!) -->
    <circle cx="32" cy="24" r="11" fill="#FFFFFF"/>
    
    <!-- LAYER 5: Kilatan Cahaya Tipis (Biar estetik/glossy) -->
    <path opacity="0.2" fill="#FFFFFF" d="M32,12c-6.6,0-12,5.4-12,12s5.4,12,12,12s12-5.4,12-12S38.6,12,32,12z"/>
</svg>\`,
