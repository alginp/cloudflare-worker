...
<body class="p-4 md:p-12">
    ...
    <g>
        ...
        <path fill="#F43F5E" d="M32,2c-12.15,0-22,9.85-22,22c0,5.799,3.469,11.469,5.913,15L32,61l16.077-22C50.281,35.781,54,29.799,54,24C54,11.85,44.15,2,32,2z"/>
        
        <!-- Layer 3: Tengah PUTIH SOLID (Nambal bolong) -->
        <circle cx="32" cy="24" r="11" fill="#FFFFFF"/>
        
        <!-- Layer 4: Aksen Sisi Agak Merah -->
        <path opacity="0.3" fill="#991B1B" d="M32,12c-6.627,0-12,5.373-12,12s5.373,12,12,12s12-5.373,12-12S38.627,12,32,12z M32,34 c-5.522,0-10-4.477-10-10s4.478-10,10-10s10,4.477,10,10S37.522,34,32,34z"/>
    </g>
</svg>\`,
        ...
        const cfIcon = L.divIcon({
            html: \`<svg width="45" height="45" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
    <g>
        <!-- LAYER DASAR: Putih Solid biar gak transparan di tengah -->
        <path fill="#FFFFFF" d="M331 326c11-26-4-38-19-38l-148-2c-4 0-4-6 1-7l150-2c17-1 37-15 43-33 0 0 10-21 9-24a97 97 0 0 0-187-11c-38-25-78 9-69 46-48 3-65 46-60 72 0 1 1 2 3 2h274c1 0 3-1 3-3z"/>
        <path fill="#FFFFFF" d="M381 224c-4 0-6-1-7 1l-5 21c-5 16 3 30 20 31l32 2c4 0 4 6-1 7l-33 1c-36 4-46 39-46 39 0 2 0 3 2 3h113l3-2a81 81 0 0 0-78-103"/>

        <!-- LAYER WARNA: Logo asli Cloudflare -->
