...
<body class="p-4 md:p-12">
    ...
    html: \`<svg width="34" height="34" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        <!-- Layer 1: Sisi Luar (Putih Abu-abu / Friendly) -->
        <path fill="#F3F4F6" d="M32,0C18.7,0,8,10.7,8,24c0,5.7,2.5,10.7,5.3,15l17.1,24.2c0.4,0.5,1,0.8,1.6,0.8s1.3-0.3,1.6-0.8L50.7,39c2.6-3.6,5.3-9.3,5.3-15C56,10.7,45.3,0,32,0z"/>
        
        <!-- Layer 2: Body Pin Utama (Orange Kemerahan) -->
        <path fill="#E11D48" d="M32,2c-12.1,0-22,9.9-22,22c0,5.8,3.5,11.5,5.9,15L32,61l16.1-22c2.4-3.5,5.9-9.2,5.9-15C54,11.9,44.1,2,32,2z"/>
        
        <!-- Layer 3: TENGAH PUTIH SOLID (Nambal bolong) -->
        <circle cx="32" cy="24" r="11" fill="#FFFFFF"/>
        
        <!-- Layer 4: Aksen Kilauan (Biar gak flat) -->
        <circle cx="32" cy="24" r="7" fill="#FB7185" opacity="0.4"/>
    </svg>\`,
    ...
    html: \`<svg width="45" height="45" viewBox="0 -70 256 256" xmlns="http://www.w3.org/2000/svg">
        <g transform="translate(0, -1)">
            ...
            <!-- LAYER WARNA: Path Kuning Cloudflare -->
