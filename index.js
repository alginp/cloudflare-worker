/**
 * ELVORA API - FINAL PIXEL-PERFECT VERSION
...
<head>
    ...
    <style>
        ...
        .grid-hero { display: grid; grid-template-cols: 1fr 1fr; gap: 24px; padding: 25px 20px; }
    </style>
</head>
<body class="p-3 md:p-6 lg:p-10">
    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="flex justify-between items-center mb-4 px-1">
            ...
            <button onclick="copyData()" id="btnCopy" class="btn-copy">
                <span id="copyIcon"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg></span>
        ...
        <!-- Bagian Data Sama Seperti Sebelumnya (Lengkap) -->
        <div class="card">
        ...
        <div class="card">
            ...
            <div class="row"><span class="label">Colo Code</span> <span class="badge badge-blue">${coloCode}</span></div>
    ...
    <script>
        ...
        // Logo Lokasi Custom (Biru di tengah)
        const locIcon = L.divIcon({
            html: \`<svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" style="width:36px;height:36px;">
                ...
                <circle cx="32" cy="24" r="10" fill="#3b82f6"></circle>
                ...
                <circle cx="32" cy="24" r="8" fill="#3b82f6"></circle>
            </svg>\`,
        ...
        function copyData() {
            ...
            navigator.clipboard.writeText(JSON.stringify(json, null, 2)).then(() => {
                ...
                setTimeout(() => { 
                    ...
                    icon.innerHTML = '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>';
